...
# Callback function Task 2
def get_pie_chart(entered_site):
    filtered_df = spacex_df
    if entered_site == 'ALL':
        pie_plot = px.pie(filtered_df, values='class', names='Launch Site', 
                    title='Total Success Launches by Site')
        return pie_plot
    else:
        # return the outcomes from selected site
        filtered_df = filtered_df[filtered_df['Launch Site'] == entered_site]
        pie_plot = px.pie(filtered_df, names='class', 
